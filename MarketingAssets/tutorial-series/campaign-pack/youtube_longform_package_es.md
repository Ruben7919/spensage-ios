...
`Despues de registrar un gasto, el siguiente atajo que mas ahorra tiempo es escanear recibos. Sigue con el tutorial 3.`

### Tutorial 3

`Si ya escaneaste un recibo, ahora toca entender tus datos de verdad. El tutorial 4 te ensena esa parte.`

### Tutorial 4

`Ya viste analisis y presupuesto. Si quieres pasar del caos al orden diario, sigue con el tutorial 5.`

### Tutorial 5

`Aqui se vuelve util en serio: cuentas, facturas y reglas. Para soporte, ayuda y planes, sigue con el tutorial 6.`

### Tutorial 6

`Si ya sabes donde esta cada herramienta, cierra la serie con el tutorial 7 para ver logros y compartir avances.`

### Tutorial 7

`Si esta serie te ayudo, guardala o mandasela a alguien que quiera ordenar sus gastos sin complicarse.`

## 5. Checklist de subida

- Titulo corto y directo.
- Thumbnail final exportado.
- Descripcion larga pegada y revisada.
- Comentario fijado correspondiente.
- Link al App Store.
- Link a la landing con UTM.
- Hashtags limitados a 3 o 4 maximo.
