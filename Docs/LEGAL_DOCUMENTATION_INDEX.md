# Índice de documentación legal de SpendSage

Última actualización: 2026-04-05

Los documentos legales fuente de verdad para la build nativa de iOS viven dentro del bundle para que los mismos textos puedan mostrarse también dentro de la app:

- `/Users/rubenlazaro/Projects/spensage-ios/SpendSage/Resources/Legal/PRIVACY_POLICY.md`
- `/Users/rubenlazaro/Projects/spensage-ios/SpendSage/Resources/Legal/TERMS_OF_USE.md`
...
- `Terms of Use`: endpoint público de términos y Centro legal dentro de la app.
- `Beta Notice and Disclosures`: Centro legal dentro de la app y contexto de beta/revisión interna.
- `Support and Contact`: endpoint público de soporte/legal y Centro legal dentro de la app.
