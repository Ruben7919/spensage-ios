...
- 2026-04-09: Uploaded TestFlight build `1.0 (29)` successfully after the tab bar geometry fix, SES invite-region isolation work, pricing/source-of-truth pass, public smoke, unit tests, and simulator build/test pass. The build is `VALID`, attached to the configured external TestFlight group, and `APPROVED` for external beta testing.
