...
- Do not add extra limbs or duplicate paws.
...
- Keep the central safe area clear for logo and animated yarn loader.
- Prefer transparent-safe edges and clean separation between characters and backdrop.
