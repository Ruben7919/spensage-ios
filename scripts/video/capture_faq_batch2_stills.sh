...
OUT_DIR="$ROOT/MarketingAssets/faq-videos/stills-batch2"
...
SETTLE_DELAY=5 capture faq_05_onboarding_rapido \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_SCREEN=onboarding \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_HIDE_GUIDES=1 \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_SKIP_SPLASH=1

SETTLE_DELAY=2.5 capture faq_06_presupuesto_guiado \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_ROUTE=budget \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_HIDE_GUIDES=1 \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_SKIP_SPLASH=1

SETTLE_DELAY=2.5 capture faq_07_premium_claro \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_ROUTE=premium \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_HIDE_GUIDES=1 \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_SKIP_SPLASH=1

SETTLE_DELAY=2.5 capture faq_08_soporte_ayuda \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_ROUTE=help \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_HIDE_GUIDES=1 \
    SIMCTL_CHILD_SPENDSAGE_DEBUG_SKIP_SPLASH=1
